...
<table>
  ...
  <tr>
    <td>Cosface</td>
    <td>R@1: 52.7, R@5: 65.5, R@10: 70.8</td>
    <td>R@1: 70.2, R@5: 84.1, R@10: 89.5</td>
    <td>R@1: 52.4, R@5: 70.5, R@10: 80.0</td>
  </tr>
  <tr>
    <td>Arcface (s = 30, m = 0.5)</td>
    <td>R@1: 27.6, R@5: 42.7, R@10: 48.0</td>
    <td>R@1: 42.9, R@5: 66.3, R@10: 74.9</td>
    <td>R@1: 21.9, R@5: 48.6, R@10: 61.0</td> 
  </tr>
  <tr>
    <td>Arcface (s = 50, m = 0.5)</td>
    <td>R@1: 32.8, R@5: 47.0, R@10: 52.1</td>
    <td>R@1: 49.2, R@5: 69.8, R@10: 77.8</td>
    <td>R@1: 32.4, R@5: 52.4, R@10: 58.1</td> 
  </tr>
  <tr>
    <td>Sphereface (s = 30, m = 3)</td>
    <td>R@1: 42.0, R@5: 56.1, R@10: 61.1</td>
    <td>R@1: 62.5, R@5: 76.5, R@10: 84.1</td>
    <td>R@1: 46.7, R@5: 56.2, R@10: 69.5</td> 
  </tr>
  <tr>
    <td>Sphereface (s = 50, m = 3)</td>
    <td>R@1: 44.0, R@5: 58.5, R@10: 63.3</td>
    <td>R@1: 61.3, R@5: 77.8, R@10: 85.1</td>
    <td>R@1: 43.8, R@5: 61.9, R@10: 71.4</td> 
  </tr>
  <tr>
    <td>Sphereface (s = 50, m = 4)</td>
    <td>R@1: 4.3, R@5: 9.9, R@10: 12.6</td>
    <td>R@1: 7.0, R@5: 23.2, R@10: 31.7</td>
    <td>R@1: 4.8, R@5: 15.2, R@10: 24.8</td> 
  </tr>
  <tr>
    <td>FDA+PP+DA (alpha 0.1)</td>
    <td>R@1: 50.9, R@5: 63.4, R@10: 69.1</td>
    <td>R@1: 73.3, R@5: 85.4, R@10: 88.6</td>
    <td>R@1: 61.0, R@5: 81.0, R@10: 83.8</td> 
  </tr>
  <tr>
    <td>FDA+PP</td>
    <td>R@1: 51.0, R@5: 65.9, R@10: 71.0</td>
    <td>??</td>
    <td>R@1: 53.3, R@5: 74.3, R@10: 77.1</td> 
  </tr>
  <tr>
    <td>FDA</td>
    <td>R@1: 51.3, R@5: 65.2, R@10: 69.8</td>
    <td>R@1: 71.7, R@5: 83.8, R@10: 88.3</td>
    <td>R@1: 53.3, R@5: 69.5, R@10: 77.1</td> 
  </tr>
  <tr>
    <td>PP</td>
    <td>R@1: 48.6, R@5: 61.9, R@10: 67.2</td>
    <td>R@1: 67.6, R@5: 82.2, R@10: 88.3</td>
    <td>R@1: 50.5, R@5: 71.4, R@10: 81.9</td> 
  </tr>
  <tr>
    <td>FDA on test</td>
    <td>R@1: 52.1, R@5: 66.6, R@10: 70.6</td>
    <td>R@1: 70.2, R@5: 84.4, R@10: 88.6</td>
    <td>R@1: 56.2, R@5: 71.4, R@10: 81.0</td> 
  </tr>
  <tr>
    <td>DA</td>
    <td>R@1: 52.7, R@5: 68.0, R@10: 73.0</td>
    <td>R@1: 71.7, R@5: 86.7, R@10: 91.1,</td>
    <td>R@1: 56.2, R@5: 78.1, R@10: 84.8</td> 
  </tr><tr>
    <td>FDA+PP+DA (alpha=0.01)</td>
    <td>R@1 50.8, R@5: 65.4, R@10: 70.2</td>
    <td>R@1: 71.4, R@5: 86.0, R@10: 88.9</td>
    <td>R@1: 55.2, R@5: 78.1, R@10: 83.8</td> 
  </tr><tr>
    <td></td>
    <td></td>
    <td></td>
